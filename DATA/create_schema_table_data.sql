CREATE TABLE orders.tb_clientes (
  id_cliente INT NULL,
...
CREATE TABLE orders.tb_pedidos (
  id_pedido INT NULL,
  id_cliente INT NULL,
...
CREATE TABLE orders.tb_vendedor (
  id_vendedor INT NULL,
  nome_vendedor VARCHAR(50) NULL,
  dept_vendedor VARCHAR(50) NULL);


INSERT INTO orders.tb_vendedor (id_vendedor, nome_vendedor, dept_vendedor)
